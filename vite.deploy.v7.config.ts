...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      './components/VisualAssets': fileURLToPath(new URL('./src/components/VisualAssetsHandDrawn.tsx', import.meta.url)),
    },
  },
  plugins: [
    react(),
    ...
    cloudflare({
      ...
      config: {
        main: './worker/index.ts', compatibility_date: '2026-08-15', compatibility_flags: ['nodejs_compat'],
